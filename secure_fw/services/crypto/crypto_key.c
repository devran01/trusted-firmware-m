...
/*!@{*/
void tfm_crypto_key_attributes_from_app(
...
void tfm_crypto_key_attributes_to_app(const psa_key_attributes_t *attributes,
                                   ...
                                   size_t out_len)
{
    ...
    tfm_crypto_key_attributes_from_app(app_attributes, partition_id,
                                       &key_attributes);
                                           ...
                                           size_t out_len)
{
    ...
    if (status == PSA_SUCCESS) {
        tfm_crypto_key_attributes_to_app(&key_attributes, app_attributes);
    }
